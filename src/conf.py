...
"""
REQUIRED_GCLOUD_ENV_VARIABLES = ["TF_WORKSPACE_FILE_LOCATION",
                          "TF_GCLOUD_BUCKET",
                          "TF_GCLOUD_CREDENTIALS"]
REQUIRED_AWS_ENV_VARIABLES = ["TF_WORKSPACE_FILE_LOCATION",
                          "TF_AWS_BUCKET",
                          "TF_AWS_PROFILE",
                          "TF_AWS_BUCKET_REGION"
]
REQUIRED_AZURE_ENV_VARIABLES = ["TF_WORKSPACE_FILE_LOCATION",
